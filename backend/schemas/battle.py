...
class PlayerSchema(BaseModel):
    ...
    heroes: list[HeroSchema] | None = Field(default=None, min_length=3, max_length=3)
    troops: TroopsSchema
...
class SimulateRequest(BaseModel):
    ...
    attacker_joiners: list[HeroSchema] = Field(default_factory=list, max_length=4)
    defender_joiners: list[HeroSchema] = Field(default_factory=list, max_length=4)
